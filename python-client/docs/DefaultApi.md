...
[**shared_dash_types_get**](DefaultApi.md#shared_dash_types_get) | **GET** /shared/DashTypes | DashTypes: List All Possible Types
...
[**slides_graphic_types_get_id**](DefaultApi.md#slides_graphic_types_get_id) | **GET** /slides/GraphicTypes/{id} | GraphicTypes: Get by Id
...
# **documents_document_type_get_id**
...
# **slides_group_elements_get_id**
> SlideGroupElements slides_group_elements_get_id(id)
...
try:
    # GroupElements: Get by Id
    api_response = api_instance.slides_group_elements_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_group_elements_get_id: %s\n" % e)
```
...
> SlideGroups slides_groups_get_id(id)
...
try:
    # Groups: Get by Id
    api_response = api_instance.slides_groups_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_groups_get_id: %s\n" % e)
```
...
# **slides_shape_trees_get_id**
> SlideShapeTrees slides_shape_trees_get_id(id)
...
try:
    # ShapeTrees: Get by Id
    api_response = api_instance.slides_shape_trees_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_shape_trees_get_id: %s\n" % e)
```
...
# **slides_slide_masters_get_id**
> SlideSlideMasters slides_slide_masters_get_id(id)
...
try:
    # SlideMasters: Get by Id
    api_response = api_instance.slides_slide_masters_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_slide_masters_get_id: %s\n" % e)
```
...
# **slides_slides_details_id**
> SlideSlides slides_slides_details_id(id)
...
try:
    # Slides: Retrieve Object Tree
    api_response = api_instance.slides_slides_details_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_slides_details_id: %s\n" % e)
```
...
> SlideSlides slides_slides_get_id(id)
...
try:
    # Slides: Get by Id
    api_response = api_instance.slides_slides_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->slides_slides_get_id: %s\n" % e)
```
...
> TableBorders tables_borders_get_id(id)
...
try:
    # Borders: Get by Id
    api_response = api_instance.tables_borders_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_borders_get_id: %s\n" % e)
```
...
# **tables_cells_get_id**
> TableCells tables_cells_get_id(id)
...
try:
    # Cells: Get by Id
    api_response = api_instance.tables_cells_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_cells_get_id: %s\n" % e)
```
...
> TableColumns tables_columns_get_id(id)
...
try:
    # Columns: Get by Id
    api_response = api_instance.tables_columns_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_columns_get_id: %s\n" % e)
```
...
# **tables_rows_get_id**
> TableRows tables_rows_get_id(id)
...
try:
    # Rows: Get by Id
    api_response = api_instance.tables_rows_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_rows_get_id: %s\n" % e)
```
...
# **tables_tables_details_id**
> TableTables tables_tables_details_id(id)
...
try:
    # Tables: Retrieve Object Tree
    api_response = api_instance.tables_tables_details_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_tables_details_id: %s\n" % e)
```
...
> TableTables tables_tables_get_id(id)
...
try:
    # Tables: Get by Id
    api_response = api_instance.tables_tables_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->tables_tables_get_id: %s\n" % e)
```
...
# **theme_themes_details_id**
> ThemeThemes theme_themes_details_id(id)
...
try:
    # Theme: Retrieve Object Tree
    api_response = api_instance.theme_themes_details_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->theme_themes_details_id: %s\n" % e)
```
...
# **theme_themes_get_id**
> ThemeThemes theme_themes_get_id(id)
...
try:
    # Themes: Get by Id
    api_response = api_instance.theme_themes_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->theme_themes_get_id: %s\n" % e)
```
...
# **themes_background_fills_get_id**
> ThemeBackgroundFills themes_background_fills_get_id(id)
...
try:
    # BackgroundFills: Get by Id
    api_response = api_instance.themes_background_fills_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_background_fills_get_id: %s\n" % e)
```
...
> ThemeColors themes_colors_get_id(id)
...
try:
    # Colors: Get by Id
    api_response = api_instance.themes_colors_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_colors_get_id: %s\n" % e)
```
...
# **themes_custom_colors_get_id**
> ThemeCustomColors themes_custom_colors_get_id(id)
...
try:
    # CustomColors: Get by Id
    api_response = api_instance.themes_custom_colors_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_custom_colors_get_id: %s\n" % e)
```
...
# **themes_effect_map_get_id**
> ThemeEffectMap themes_effect_map_get_id(id)
...
try:
    # EffectMap: Get by Id
    api_response = api_instance.themes_effect_map_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_effect_map_get_id: %s\n" % e)
```
...
# **themes_fills_get_id**
> ThemeFills themes_fills_get_id(id)
...
try:
    # Fills: Get by Id
    api_response = api_instance.themes_fills_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_fills_get_id: %s\n" % e)
```
...
# **themes_fonts_get_id**
> ThemeFonts themes_fonts_get_id(id)
...
try:
    # Fonts: Get by Id
    api_response = api_instance.themes_fonts_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_fonts_get_id: %s\n" % e)
```
...
> list[ThemeIntensity] themes_intensity_get()
...
try:
    # Intensity: List All Possible Types
    api_response = api_instance.themes_intensity_get()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_intensity_get: %s\n" % e)
```
...
> ThemeIntensity themes_intensity_get_id(id)
...
try:
    # Intensity: Get by Id
    api_response = api_instance.themes_intensity_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_intensity_get_id: %s\n" % e)
```
...
# **themes_line_map_get_id**
> ThemeLineMap themes_line_map_get_id(id)
...
try:
    # LineMap: Get by Id
    api_response = api_instance.themes_line_map_get_id(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->themes_line_map_get_id: %s\n" % e)
```
