...
class FillTypesApi(object):
    ...
    def o_a_fill_types_get(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.o_a_fill_types_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.o_a_fill_types_get_with_http_info(**kwargs)  # noqa: E501

    def o_a_fill_types_get_with_http_info(self, **kwargs):  # noqa: E501
        """FillTypes: List All Possible Types  # noqa: E501

        List Types: Use this method to retreive a list of possible options for the FillTypes type. Use the Id from oneof the returned elements on to make changes to elements in the Shared object space.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_fill_types_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method o_a_fill_types_get" % key
                )
    ...
    def o_a_fill_types_get_id(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.o_a_fill_types_get_id_with_http_info(id, **kwargs)  # noqa: E501

    def o_a_fill_types_get_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """FillTypes: Get by Id  # noqa: E501

        Get by Id: Use this method to retrieve a FillTypes object by its primary key (id)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_fill_types_get_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_a_fill_types_get_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `o_a_fill_types_get_id`")  # noqa: E501
