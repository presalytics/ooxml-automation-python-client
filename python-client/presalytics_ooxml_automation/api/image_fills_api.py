...
class ImageFillsApi(object):
    ...
    def o_a_image_fills_get_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.o_a_image_fills_get_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.o_a_image_fills_get_id_with_http_info(id, **kwargs)  # noqa: E501

    def o_a_image_fills_get_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """ImageFills: Get by Id  # noqa: E501

        Get by Id: Use this method to retrieve a ImageFills object by its primary key (id)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_image_fills_get_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method o_a_image_fills_get_id" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `o_a_image_fills_get_id`")  # noqa: E501
    ...
    def o_a_image_fills_put_id(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_image_fills_put_id(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.o_a_image_fills_put_id_with_http_info(id, **kwargs)  # noqa: E501

    def o_a_image_fills_put_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """ImageFills: Modify Values  # noqa: E501

        PUT: Use this method for simple updates to ImageFills objects.   Please Note: Using this method sidesteps some data validation steps executed by base objects.  Please review the documentation and ECMA-376 prior to using this method. Per IETF 7231, all fields must be include in PUT requests, even though user and timestamp fields will be modified by the server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_image_fills_put_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_a_image_fills_put_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `o_a_image_fills_put_id`")  # noqa: E501
