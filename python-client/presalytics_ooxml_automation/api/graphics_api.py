...
class GraphicsApi(object):
    ...
    def o_a_graphics_get_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.o_a_graphics_get_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.o_a_graphics_get_id_with_http_info(id, **kwargs)  # noqa: E501

    def o_a_graphics_get_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Graphics: Get by Id  # noqa: E501

        Get by Id: Use this method to retrieve a Graphics object by its primary key (id)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_a_graphics_get_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method o_a_graphics_get_id" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `o_a_graphics_get_id`")  # noqa: E501
